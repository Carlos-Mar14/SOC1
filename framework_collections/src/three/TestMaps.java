...
public class TestMaps {
	...
	//array de objetos Profesor[] llamado profesores={}
	private final static Profesor[] profesores = { new Profesor(1, "Antonio Ferranz"), new Profesor(6, "Belen Martin"),
			new Profesor(3, "Carmelo Sanchez"), new Profesor(4, "Damian Burgos"), new Profesor(5, "Julian Roman"),
			new Profesor(2, "Zacarias Gomez") 
	};
	
	//Metodo
	private static void rellenar(Map<Integer, Profesor> mprofesores, Profesor[] p) {
	...
	//Metodo
	private static void probando(Map<Integer, Profesor> mprofesores, Profesor[] p) {
		System.out.println("Probando " + mprofesores.getClass().getName());
