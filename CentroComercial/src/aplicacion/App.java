...
public class App {
	...
	public static void main(String[] args) {
		...
		Local comida [] = {new LocalComida("El Comensal", "14-23", 3,4), new LocalComida("Colombia a la Carta", "14-23", 3,3)};
		
		Local bar = new Comida_Bar("Licores La Perdición", "14-23", 3,4);
		
		System.out.println("Centro Comerciar: " + cc.getNameCentroComercial()+ "\nCantidad de Locales: " + cc.getCantLocales() + "\nLocales: ");
		...
		System.out.println("         " + mixta.getName() + " - " + "Tienda de Ropa Mixta" + "  paga un impuesto de: " + impuestoMixta  );
		double impuestLibro = libro.calculoImpuesto();
		System.out.println("         " + libro.getName() + " - " + "Libreria" + "  paga un impuesto de: " + impuestLibro);
		/*
		double impuestoComida1 = comida.calculoImpuesto();
		System.out.println("         " + comida[0].getName() + " - " + "Comedor" + " Y paga un impuesto de: " + impuestoComida1);
		double impuestoComida2 = comida.calculoImpuesto();
		System.out.println("         " + comida[1].getName() + " - " + "Comedor" + " Y paga un impuesto de: " + impuestoComida2);
		*/
